...
{\Large
    \begin{equation*}
        \int\int\int_{\mathbb{V}}f(x,y,z)\,dx\,dy\,dz
    \end{equation*}
}
...
\begin{boxedeq}[0.8]
    \int\int\int_{\mathbb{V}}f(x,y,z)\,dx\,dy\,dz = \int\int_\mathbb{B}\left(\int_{f_1(x,y)}^{f_2(x,y)} f(x,y,z)\,dz\right)\,dx\,dy
\end{boxedeq}

Se $\mathbb{V}$ for um domínio de \textbf{tipo 1}:
\begin{boxedeq}[0.8]
    \int\int\int_{\mathbb{V}}f(x,y,z)\,dx\,dy\,dz = \int_a^b\left(\int\int_{A(z)} f(x,y,z)\,dx\,dy\right)\,dz
\end{boxedeq}
...
\begin{boxedeq}[0.9]
    \int\int_{\mathbb{D}_{x,y}} f(x,y)\,dx\,dy = \int\int_{\mathbb{D}_{u,v}^{*}} f(x(u,v),y(u,v))\left|\det\left[\frac{\partial(x,y)}{\partial(u,v)}\right]\right|\,du\,dv
\end{boxedeq}
